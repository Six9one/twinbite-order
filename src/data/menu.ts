...
export const pizzasTomate: MenuItem[] = [
  { id: 'pizza-t-1', name: 'Margherita', description: 'Tomate, mozzarella, origan', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-2', name: 'Reine', description: 'Tomate, mozzarella, jambon, champignons', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-3', name: 'Orientale', description: 'Tomate, mozzarella, merguez, poivrons, oignons', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-4', name: 'Végétarienne', description: 'Tomate, mozzarella, légumes grillés, olives', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-5', name: 'Calzone', description: 'Pizza pliée, jambon, œuf, champignons, fromage', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-6', name: 'Quatre Saisons', description: 'Tomate, mozzarella, jambon, champignons, artichauts, olives', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-7', name: 'Napolitaine', description: 'Tomate, mozzarella, anchois, câpres, olives', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-8', name: 'Sicilienne', description: 'Tomate, mozzarella, thon, oignons, olives', price: 18, category: 'pizzas', base: 'tomate' },
  { id: 'pizza-t-9', name: 'Hawaïenne', description: 'Tomate, mozzarella, jambon, ananas', price: 18, category: 'pizzas', base: 'tomate' },
...
export const pizzasCreme: MenuItem[] = [
  { id: 'pizza-c-1', name: 'Savoyarde', description: 'Crème, mozzarella, pommes de terre, lardons, reblochon', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-2', name: 'Quatre Fromages', description: 'Crème, mozzarella, gorgonzola, chèvre, parmesan', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-3', name: 'Chèvre Miel', description: 'Crème, mozzarella, chèvre, miel, noix', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-4', name: 'Saumon', description: 'Crème, mozzarella, saumon fumé, aneth', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-5', name: 'Tartiflette', description: 'Crème, pommes de terre, lardons, oignons, reblochon', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-6', name: 'Raclette', description: 'Crème, pommes de terre, jambon, raclette', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-7', name: 'Carbonara', description: 'Crème, mozzarella, lardons, œuf, parmesan', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-8', name: 'Forestière', description: 'Crème, mozzarella, champignons, lardons', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-9', name: 'Montagnarde', description: 'Crème, mozzarella, jambon cru, roquette, parmesan', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-10', name: 'Normande', description: 'Crème, mozzarella, camembert, pommes, lardons', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-11', name: 'Poulet Curry', description: 'Crème, mozzarella, poulet, sauce curry, oignons', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-12', name: 'Bleu', description: 'Crème, mozzarella, roquefort, noix, miel', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-13', name: 'Paysanne', description: 'Crème, mozzarella, pommes de terre, saucisse, oignons', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-14', name: 'Océane', description: 'Crème, fruits de mer, ail, persil', price: 18, category: 'pizzas', base: 'creme' },
  { id: 'pizza-c-15', name: 'Twin Crème', description: 'Crème, mozzarella, poulet, champignons, lardons, œuf', price: 18, category: 'pizzas', base: 'creme' },
];

// ============= TACOS =============
export const tacos: MenuItem[] = [
  { id: 'tacos-solo', name: 'Tacos Solo', description: '1 viande au choix, frites, fromage, sauce', price: 7, category: 'tacos' },
  { id: 'tacos-double', name: 'Tacos Double', description: '2 viandes au choix, frites, fromage, sauces', price: 9, category: 'tacos' },
  { id: 'tacos-triple', name: 'Tacos Triple', description: '3 viandes au choix, frites, fromage, sauces', price: 11, category: 'tacos' },
];

// ============= SOUFFLÉS =============
export const soufflets: MenuItem[] = [
  { id: 'souffle-solo', name: 'Soufflé Solo', description: '1 viande, sauce, garnitures au choix', price: 6, category: 'soufflets' },
  { id: 'souffle-double', name: 'Soufflé Double', description: '2 viandes, sauces, garnitures au choix', price: 8, category: 'soufflets' },
  { id: 'souffle-triple', name: 'Soufflé Triple', description: '3 viandes, sauces, garnitures au choix', price: 10, category: 'soufflets' },
];

// ============= MAKLOUB =============
export const makloub: MenuItem[] = [
  { id: 'makloub-solo', name: 'Makloub Solo', description: '1 viande, garnitures, sauces', price: 6, category: 'makloub' },
  { id: 'makloub-double', name: 'Makloub Double', description: '2 viandes, garnitures, sauces', price: 8, category: 'makloub' },
];
...
export const croques: MenuItem[] = [
  { id: 'croque-monsieur', name: 'Croque Monsieur', description: 'Jambon, fromage gratiné', price: 4.5, category: 'croques' },
...
export const milkshakes: MenuItem[] = [
  ...
  { id: 'milk-chocolat', name: 'Milkshake Chocolat', description: 'Chocolat intense', price: 4, category: 'milkshakes' },
...
export const crepes: MenuItem[] = [
  ...
  { id: 'crepe-banane-nutella', name: 'Crêpe Banane Nutella', description: 'Banane fraîche et Nutella', price: 5, category: 'crepes' },
...
export const gaufres: MenuItem[] = [
  ...
  { id: 'gaufre-choco', name: 'Gaufre Chocolat', description: 'Sauce chocolat chaude', price: 4.5, category: 'gaufres' },
  { id: 'gaufre-complete', name: 'Gaufre Complète', description: 'Nutella, banane, chantilly', price: 6, category: 'gaufres' },
];

// ============= BOISSONS =============
export const boissons: MenuItem[] = [
  { id: 'coca-33', name: 'Coca-Cola', description: '33cl', price: 2, category: 'boissons' },
