...
export default function TVDashboard() {
  ...
  // NOTE: Realtime WebSocket disabled due to connection issues
  // Using polling (above) and fallback detection (below) instead
  // The 5-second interval refresh handles new order detection reliably
