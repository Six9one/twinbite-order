            ...
            <div className="flex gap-8 max-w-4xl w-full">
                ...
                >
                    <div className="text-center">
                        ...
                        <h3 className="text-4xl font-bold text-white mb-3">Sur Place</h3>
                        <p className="text-lg text-white/60">Je mange ici</p>
                    </div>
                </Card>
                ...
                >
                    <div className="text-center">
                        <span className="text-8xl block mb-6">🛍️</span>
                        <h3 className="text-4xl font-bold text-white mb-3">À Emporter</h3>
                        <p className="text-lg text-white/60">Je prends à emporter</p>
                    </div>
                </Card>
            </div>
        </div>
